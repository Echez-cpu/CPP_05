...
void			Bureaucrat::executeForm(AForm const & form) {
	if (this->input_grade > form.getExecuteGrade()) {
		std::cout << this->input_name << " can't execute " << form.getName() << "." << std::endl;
		throw AForm::GradeTooLowException();
	}
	std::cout << this->input_name << " executed " << form.getName() << "." << std::endl;
}
